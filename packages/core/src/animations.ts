export interface AnimationKeyframeStop {
  x?: number;
  y?: number;
  scale?: number;
  scaleX?: number;
...
export interface AnimationKeyframeData {
  [stop: string]: AnimationKeyframeStop;
}

export interface AnimationPresetDefaultOptions {
  easing: string;
  iterCount: number | typeof Infinity;
}

export interface AnimationPresetConfig {
  label: string;
  type: "keyframes";
  defaultOptions: AnimationPresetDefaultOptions;
...
export function getPresetKeyframes(key: string): AnimationKeyframeData {
