    ...
    <header className="flex h-12 w-full shrink-0 items-center px-4 bg-card z-10 border-b">
      ...
      <div className="flex items-center justify-end gap-3 w-[280px]">
        ...
        <div className="flex items-center gap-1">
          ...
          <button className="flex items-center gap-2 px-3 py-1.5 bg-foreground text-background text-xs font-medium rounded-md hover:bg-foreground/90 transition-colors">
...
function FakeMediaPanel() {
  ...
  return (
    <div className="w-72 border-r border-border/30 flex flex-col bg-card/20 shrink-0">
...
function FakeTimelinePanel() {
  return (
    <div className="flex flex-col bg-card h-64">
      ...
      <div className="h-10 border-b border-border/30 flex items-center justify-between px-3 bg-card/20 shrink-0">
        {/* Left: Track tools - matching real timeline header */}
        <div className="flex items-center gap-1">
        ...
        {/* Center: Playback controls - matching real timeline header icons */}
        ...
        {/* Right: Zoom controls - matching real timeline header */}
        <div className="flex items-center gap-2">
          <button className="p-1.5 text-muted-foreground/70 hover:text-muted-foreground hover:bg-muted/50 rounded transition-colors">
...
function FakeAssistantPanel() {
  return (
    <div className="w-72 border-l border-border/30 flex flex-col bg-card/20 shrink-0">
      {/* Header */}
