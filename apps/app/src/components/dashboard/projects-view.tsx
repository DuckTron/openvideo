...
import { RiMoreLine, RiFolderLine, RiAddLine, RiDeleteBinLine } from "@remixicon/react";
  ...
  return (
    ...
    >
      ...
      <div className="aspect-square bg-secondary/30 flex items-center justify-center relative">
        <RiFolderLine className="size-10 text-muted-foreground/40" strokeWidth={1.5} />
          ...
          {isLoading ? (
            ...
            <div className="flex flex-col items-center justify-center h-[60vh] text-center">
              <div className="p-4 rounded-xl bg-secondary/50 mb-4">
                <RiFolderLine className="size-8 text-muted-foreground/60" strokeWidth={1.5} />
              </div>
