...
export function AssetGeneratorModal({ open, onOpenChange }: AssetGeneratorModalProps) {
  ...
  }, [prompt, currentTypeOption.label, onOpenChange]);
  ...
  }, [open, handleGenerate, handleClose]);

  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[600px] p-0 bg-popover">
        ...
        <div className="p-6">
          ...
          <div className="relative mb-4">
            <textarea
              ...
              autoFocus
            />
            <div className="absolute bottom-3 right-3 flex items-center gap-2 text-[10px] text-muted-foreground/60">
          ...
          <div className="flex items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <Button variant="ghost" size="sm" className="h-8 text-xs" onClick={handleSurpriseMe}>
                <RiSparkling2Line className="size-3.5 mr-1" />
                Surprise me
              </Button>
              <Button
                size="icon"
