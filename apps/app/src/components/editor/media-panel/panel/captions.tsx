        ...
        {mediaItems.length === 0 ? (
          ...
          <div className="flex flex-1 flex-col gap-3 p-4">
            ...
            <div className="flex flex-col gap-2">
              ...
              >
                {isGenerating ? (
                  <RiLoader5Line className="size-5 animate-spin shrink-0" />
                ) : (
                  <RiSparkling2Line className="size-5 shrink-0" />
                )}
              ...
              >
                <RiKeyboardLine className="size-5 shrink-0" />
                <div className="flex flex-col items-start gap-0.5 flex-1">
              ...
              <Button
                ...
                className="h-auto py-3 px-4 flex items-center gap-3 border-border/60 bg-secondary/30 hover:bg-secondary/50 text-foreground opacity-50 justify-start"
              >
                <RiUploadLine className="size-5 shrink-0" />
                <div className="flex flex-col items-start gap-0.5 flex-1">
              ...
              <Button
                ...
                className="h-auto py-3 px-4 flex items-center gap-3 border-border/60 bg-secondary/30 hover:bg-secondary/50 text-foreground opacity-50 justify-start"
              >
                <RiPaletteLine className="size-5 shrink-0" />
                <div className="flex flex-col items-start gap-0.5 flex-1">
