...
const DEFAULT_CHROME_URL = "https://openvideo.dev/editor";
...
export function BrowserShell({
  ...
  return (
    <div
      className={cn("overflow-hidden border shadow-2xl dark:shadow-primary/5", className)}
    ...
    >
      <div className="flex h-full w-full flex-col overflow-hidden bg-background dark:bg-background-100">
        <div className="flex items-center justify-between gap-2 border-primary/5 border-b px-4 py-1">
          <div className="flex w-20 gap-2" data-slot="browser-shell-traffic-lights">
